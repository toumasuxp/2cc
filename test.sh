...
try "l_var test" 10 "int main(){int x = 10;return x;}"
try "l_var_assign test" 9 "int main(){int x = 4;x = 4 + 5;return x;}"
try "g_var_pointer test" 5 "int x = 5; int main(){ int *y = &x; return *y;}"
try "l_var_pointer test1" 5 "int main(){int x = 5; int *y = &x; return *y;}"
try "l_var_pointer test2" 10 "int main(){int x = 5; int *y = &x;x = 10; return *y;}"
try "array test" 4 "int main(){int x[] = {3, 4, 5}; return x[1];}"